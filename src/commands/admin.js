...
const commands = [
  ...
  { name: 'setdailycap', desc: 'Set daily XP cap (0 = disabled)', opts: (b) => b.addIntegerOption((o) => d(o.setName('amount').setRequired(true).setMinValue(0), 'Daily XP cap; 0 disables')), run: (i) => GuildConfigService.setDailyCap(i.guild.id, i.options.getInteger('amount'), i.user.id) },
